...
void handleRoot(){ 
      ...
      if ( serverhttp.hasArg("SSID") ) {       // si reception 
      ssid=serverhttp.arg("SSID");
      ...
      if ( serverhttp.hasArg("PASSWORD") ) {       // si reception 
      password=serverhttp.arg("PASSWORD");
      ...
      for (int i = 0; i < c; i++) { 
       ...
       serverhttp.send ( 200, "text/html", page_handleroot() );   // envoi de la page
    }
