...
void cssRoot(){
   serverhttp.send ( 200, "text/css", cssPage() );   // envoi de la page
  }
...
String page =F("body{display: flex;flex-direction: row;font-family: Arial,sans-serif;color: rgb(72,11,08);}");
       ...
       page +=F("#page{display: flex;flex-direction: column;}");
       page +=F("header{padding: 2%;margin: 1%;background-color: rgb(216,239,192);border-radius: 10px;box-shadow: 6PX 6PX 6PX silver;}");
       page +=F("#corp{display: flex;flex-direction: row;flex-wrap: wrap;}");
       page +=F("footer a{color: rgb(148,58,61);}");     
       page +=F(" section{width:44%; background-color:rgb(216,239,192);; padding:2%;margin:1%; border-radius:10px; box-shadow:6PX 6PX 6PX silver;}");
